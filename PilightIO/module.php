 ...
 *
 */
class PilightIO extends Module
{
    use InstanceHelper;
    ...
    public function Create()
    {
        ...
        $this->RegisterTimer('UpdateData', 0, $this->_getPrefix() . '_UpdateDevices($_IPS[\'TARGET\']);');
    }
    ...
    private function Api($request = 'check', $params = [])
    {
        ...
        if ($params) {
            $this->_log('pilight response', $response);
        }
    ...
    public function ForwardData($JSONString)
    {
        ...
        $this->Api('control', $data);

        // log data
        $this->_log('pilight request', $JSONString);
    }
